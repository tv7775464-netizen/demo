...
QuestNeta = function()
	...
	local Library = loadstring(game:HttpGet("https://luacrack.site/index.php/Nguyenanhkhoarb79gmail.com/raw/RedzUI.lua"))():MakeWindow({
    Title = "Abacaxi Hub",
...
return FastAttackModulemastAttackModulem